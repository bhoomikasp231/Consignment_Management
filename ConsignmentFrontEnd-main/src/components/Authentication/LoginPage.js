...
const LoginPage = ({setmodalIsOpen, setLoginOpen, setisForgotPas, setIsLogin}) =>{
    ...
    <button style={{width:'25%', height:'40px', marginTop:'15px', borderRadius:'3em', border:'none', background:'  rgb(2, 66, 66)', color:'white', cursor:'pointer',boxShadow: 'rgba(0, 0, 0, 0.3) 0px 19px 38px, rgba(0, 0, 0, 0.22) 0px 15px 12px' }} className="custom-button" onClick={handleSignIn} disabled={isButtonDisable}>{loginBtnText}</button>
    </div>
